...
public class TrueTypeFont {
    private static final String pixelFontPath = "assets/fonts/PixelFont.ttf";

    public static BitmapFont getFont(int fontSize, Color fontColor) {
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal(pixelFontPath));
    ...
    public static BitmapFont getFont(int fontSize, Color fontColor, Color backFontColor) {
